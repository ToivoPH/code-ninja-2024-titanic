...
plt.pie(category_count, explode=(0, 0.1, 0), labels=category_count.index, autopct='%1.1f%%', startangle=90)
plt.show()
plt.savefig('demopieagetitanic.png')

#Using a Pie chart, create 3 categories that shows the survival rates based on age:
#Children: > 16
#Adults: 16 < x < 60
#Elderly: > 61
